    ...
    <div class="workArea">
        ...
        <div data-ride="carousel" class="carousel-of-product carousel" id="carousel-of-product">
            ...
            <ol class="carousel-indicators">
                ...
                <c:forEach items="${carouselImages }" varStatus="status" var="c">
                	<li data-slide-to="${status.index+1 }" data-target="#carousel-of-product" class=""></li>
                </c:forEach>
            </ol>
            <!-- Wrapper for slides -->
            <div role="listbox" class="carousel-inner">
                ...
                <c:forEach items="${carouselImages }" var="c">
                	<div class="item">
	                    <img src="img/product/${c.carousel_imgs}" class="carouselImage">
	                </div>
                </c:forEach>
