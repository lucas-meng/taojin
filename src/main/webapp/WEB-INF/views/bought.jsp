...
<script>
    ...
    $(function () {
        ...
        $(".selAddress").click(function () {
            alert($(this).next(".selAddresss").val());
        ...
        <c:forEach items="${orders}" var="o">
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    ...
                    <td colspan="2"><img width="13px" src="img/fore/orderItemTmall.png">淘金网</td>
                    <td colspan="1">
                        <a class="wangwanglink">
                            <!-- <div class="orderItemWangWangGif"></div> -->
                           	<input type="button" value="查看物流" class="selAddress">
                           	<input type="hidden" value="${o.address }" class="selAddresss" >
                        </a>
                        ...
                        <c:if test="${st.count==1}">
                            ...
                            <td valign="top" rowspan="${fn:length(o.orderItems)}"
                                ...
                                <c:if test="${o.status=='waitPay' }">
                                    <a href="pay?pay_id=${o.id}&price=${o.total}&type=1&param=tj">
