...
<script>
    $(function () {
        ...
        $(".selAddress").click(function() {
	    	var str = "收货人："+$(this).find(".selName").html();//选择孙元素
			str += "\n电话："+$(this).find(".selPhone").html();
			str += "\n地址："+$(this).children(".selAddressAddress").html();//选择儿元素
			$("#order_address").val(str);
	    });
    });
    function checks(){
...
<div class="buyPageDiv">
    <form action="createOrder" method="post" onsubmit="return checks()">
        ...
        <div class="address">
            ...
            <div>
                ...
                <table width="100%" height="60">
		            <tr>
		            	<td width="10%" align="center">请选择</td>
		        ...
		        <c:if test="${!empty listAddress }">
			        <c:forEach items="${listAddress }" var="address">
			            <table width="100%" border="" height="60" background="green">
			                <tr class="selAddress">
			                	<td width="10%" align="center">
			                        <input type="radio" value="${address.id }" name="addressId" >
			                    </td>
			                    <td width="10%">
			                        <b class="selName">${address.name }</b>
			                    </td>
			                    <td class="selAddressAddress">${address.address }</td>
			                    <td width="20%">
			                    	<b class="selPhone">${address.phone }</b>
			                    </td>
			                </tr>
			            </table>
			            <br>
		        ...
		        <c:if test="${empty listAddress }">
			        <div align="center"><h2><a href="personalAddress">你还没有收货地址，点我去增加收货地址哦！</a></h2></div>
		        </c:if>
        ...
        <div class="submitOrderDiv">
        	<input type="hidden" value="" id="order_address" name="address">
